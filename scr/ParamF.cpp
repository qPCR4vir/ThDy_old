...
int main(array<System::String ^> ^args)
{
	...
	Application::Run(gcnew ParF());
	return 0;
}
void 		ParF::InitializeTagBindings()
{
	...
	//this->dGVw_TmCalcRes->Rows->Add("Up");
	//this->dGVw_TmCalcRes->Rows->Add("Down");
	//this->dGVw_TmCalcRes->Rows->Add("Interaction");
	//	

	//	
	//	
	//	[0]->HeaderCell->Value =  "Up" ;
	//this->dGVw_TmCalcRes->
